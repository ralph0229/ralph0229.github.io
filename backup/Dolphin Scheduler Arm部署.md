...
但是postgre和zookeeper在docker上的镜像已经404

<img width="1622" height="808" alt="Image" src="https://github.com/user-attachments/assets/69eae9f3-63c1-417f-aa6b-95c3de643e49" />

<img width="1229" height="683" alt="Image" src="https://github.com/user-attachments/assets/0f2df94e-9f43-418c-905e-4987c0657048" />

修改下官方的docker-compose.yml(修改postgresql和zookeeper)
...
不管你是用那种方式启动的服务，只要服务启动后，你都可以通过 [http://localhost:12345/dolphinscheduler/ui](http://localhost:12345/dolphinscheduler/ui) 访问 DolphinScheduler。访问上述链接后会跳转到登陆页面，DolphinScheduler 默认的用户和密码分别为 `admin` 和 `dolphinscheduler123`。